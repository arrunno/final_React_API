package com.arunas.hometasks.api.advice;

import com.arunas.hometasks.api.exception.FileException;
import com.arunas.hometasks.api.exception.ProductNotFoundException;
import com.arunas.hometasks.api.exception.data.ExceptionResponse;
...
public class ExceptionAdvice {
    ...
    public ExceptionResponse handlingProductNotFound(ProductNotFoundException exception) {
        return new ExceptionResponse(String.format("Task %s not found", exception.getId()), HttpStatus.NOT_FOUND);
    }
